...
export default function RekeningPembayaranPage() {
  return (
      ...
      <Card className="mx-auto w-full">
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            ...
            <div className="font-semibold text-green-500 text-xl">Rp 170.000</div>
          </div>
        ...
        <CardFooter>
          <Button className="w-full" asChild>
            <Link to="/member/verify">Konfirmasi Pembayaran</Link>
          </Button>
        </CardFooter>
      </Card>
    </section>
