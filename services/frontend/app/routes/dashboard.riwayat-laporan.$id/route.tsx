...
export default function RiwayatLaporanLaba() {
    ...
    <PageContainer>
      <div className="space-y-8">
        <div className="flex items-center gap-3">
          <BackButton to={`/dashboard/proyek/report/${data.id}`} />
          <h2 className="~text-base/2xl font-bold tracking-tight">Riwayat Laporan</h2>
        </div>
        <div className="flex">
          <button
            type="button"
