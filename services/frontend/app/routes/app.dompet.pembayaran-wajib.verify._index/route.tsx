...
import { usePaySimpananWajib } from "~/services/top-up/pay-simpanan-wajib";
...
export default function VerifikasiDompetPembayaranWajibPage() {
  const [open, setOpen] = useState(false);
  const { mutateAsync: paySimpananWajib } = usePaySimpananWajib();
    ...
    <section className="mx-auto my-auto grid w-full max-w-2xl gap-6 overflow-auto rounded-md bg-white p-5 shadow-md">
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          <BackButton to="/app/dompet/pembayaran-wajib" />
